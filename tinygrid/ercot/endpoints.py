"""Low-level ERCOT API endpoint wrappers.

This module contains wrapper methods for all pyercot endpoints.
These are thin wrappers that handle pagination, retry, and DataFrame conversion.

Note: Tests should patch endpoints at 'tinygrid.ercot.endpoints.<endpoint_name>'
"""
...
# Import endpoint modules directly from pyercot
...
class ERCOTEndpointsMixin:
    """Mixin class providing low-level endpoint wrapper methods.

    These methods wrap pyercot API endpoints with:
    - Automatic retry with exponential backoff
    - Pagination handling
    - DataFrame conversion

    Requires ERCOTBase methods: _call_endpoint, _call_endpoint_model,
    _products_to_dataframe, _model_to_dataframe, _product_history_to_dataframe
    """
